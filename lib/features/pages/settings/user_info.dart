...
class _UserInfoScreenState extends State<UserInfoScreen> {
  ...
  Future<void> _editNutritionGoals() async {
    final prefs = await SharedPreferences.getInstance();
    final calories = prefs.getDouble('daily_calories') ?? 2000;
    final protein = prefs.getDouble('daily_protein') ?? 150;
    final carbs = prefs.getDouble('daily_carbs') ?? 200;
    final fats = prefs.getDouble('daily_fats') ?? 65;
